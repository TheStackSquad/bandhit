//src/app/create_profile/vendor_profile/page.jsx


"use client";

import React, { Suspense } from "react";
import VendorProfile from "@/components/UI/profileLayout/vendorProfileForm";
  ...
  return (
    <ProtectedLayout>
      ...
      >
        ...
        <h1 className="text-3xl font-bold text-gray-800 text-center mb-2">Create Vendor Profile</h1>
        ...
        {/* Suspense Wrapper */}
        <Suspense fallback={<LoadingScreen message="Loading Vendor Profile..." />}>
          <VendorProfile />
        </Suspense>
      </div>
    </ProtectedLayout>
