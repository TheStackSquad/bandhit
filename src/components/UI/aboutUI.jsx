...
const AboutUI = () => {
  ...
  return (
    <div className="relative bg-gradient-to-r from-slate-800 to-slate-900 text-white overflow-hidden">
      {/* Clip Path Section */}
      <div className="absolute inset-0 clip-path-custom bg-gradient-to-br from-slate-900 to-slate-700 opacity-80 z-0"></div>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-between gap-12">
          ...
          <div className="max-w-2xl lg:w-1/2">
            ...
            <p className="text-lg leading-relaxed mb-8">
              BandHit is your one-stop platform for seamless ticketing, 
              vendor connections, and entertainment booking.
              Whether you are an event organizer,
              a vendor, or an entertainer,
              we bring you together to create
              unforgettable moments.
            </p>
            <div className="flex gap-4 justify-center lg:justify-start">
              <button className="bg-yellow-400 text-black px-6 py-3 rounded-lg hover:bg-yellow-500 transition-transform transform hover:scale-105 shadow-md">
                Learn More
              </button>
              <button className="bg-transparent border-2 border-yellow-400 text-yellow-400 px-6 py-3 rounded-lg hover:bg-yellow-400 hover:text-black transition-transform transform hover:scale-105 shadow-md">
                Get Started
              </button>
            </div>
          </div>
          ...
          <div className="w-full lg:w-1/2 flex items-center justify-center">
            <Image
              src="/uploads/ticket/ticket.avif"
              alt="About BandHit"
