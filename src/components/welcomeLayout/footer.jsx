        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/find-tickets" className="hover:text-gray-400">Find Tickets</a></li>
              <li><a href="/event-categories" className="hover:text-gray-400">Event Categories</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/create-profile" className="hover:text-gray-400">Create Profile</a></li>
